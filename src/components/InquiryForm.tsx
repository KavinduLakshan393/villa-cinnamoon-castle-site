...
export function InquiryForm() {
  ...
  return (
    <form ref={formRef} className="form-card" noValidate aria-busy={submitting || undefined} onSubmit={submit}>
      ...
      <div className="form-actions"><AnimatedButton className="button" type="submit" disabled={submitting}>Send inquiry <span aria-hidden="true">→</span></AnimatedButton><span className="muted">At least one contact method is required.</span></div>
