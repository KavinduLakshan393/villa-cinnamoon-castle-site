...
export default function VillaPage() {
  return <main id="main">
    ...
    <section className="section" id="work"><div className="container"><div className="story-grid story-grid--reverse"><div className="story-copy reveal"><p className="eyebrow">Work and daily life</p><TextReveal text="A kitchen, workspace and laundry facilities." as="h2" /><TextReveal text="The full kitchen includes cooking essentials and appliances. Upstairs, a dedicated work table supports remote work or study, and a washing machine is available for longer stays." as="p" className="lede" delayOffset={0.2} /><div className="stat-line"><span className="stat-pill">High-speed Wi-Fi</span><span className="stat-pill">Dedicated workspace</span><span className="stat-pill">Full kitchen</span><span className="stat-pill">Washing machine</span></div></div><div className="media-stack reveal"><div className="image-frame image-frame--portrait"><ResponsivePicture image={workspace} sizes="(max-width: 860px) 100vw, 50vw" /></div><div className="image-frame image-frame--landscape"><ResponsivePicture image={kitchen} sizes="(max-width: 860px) 100vw, 50vw" /></div></div></div></div></section>
    <section className="section section--sand" id="parking"><div className="container"><div className="section-heading reveal"><div><p className="eyebrow">Outside and access</p><TextReveal text="Garden outlooks and free gated parking." as="h2" /></div><TextReveal text="The exterior includes mature tropical trees, a green lawn, porch and balcony areas. Parking is available behind the gate on the premises." as="p" className="lede" delayOffset={0.2} /></div><div className="cards">
    ...
    <section className="section section--paper"><div className="container"><div className="section-heading reveal"><div><p className="eyebrow">Confirmed facilities</p><TextReveal text="What is included." as="h2" /></div><TextReveal text="Unknown or unapproved details are deliberately not filled with assumptions." as="p" className="lede" delayOffset={0.2} /></div><div className="feature-list reveal">{facilities.map(([title, copy]) => <div className="feature-row" key={title}><strong>{title}</strong><span>{copy}</span></div>)}</div><div className="button-row" style={{ marginTop: "2rem" }}><AnimatedButton className="button" href="/contact/">Check dates</AnimatedButton><AnimatedButton className="button button--quiet" href="/gallery/">Open the gallery</AnimatedButton></div></div></section>
  </main>;
}
